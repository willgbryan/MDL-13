...
export default function Picks() {
    ...
    const predictions = [
        ...
        { game: "LAC @ CLE", moneyline: { LAC: -122, CLE: 102 }, spread: { favorite: "LAC", line: 1.5 }, ou: { line: 43.0, prediction: "Over" }, pointDiff: 0.09, winner: "CLE", projectedScore: { LAC: 20.81, CLE: 20.90 } },
        ...
        { game: "CHI @ ARI", moneyline: { CHI: -102, ARI: -118 }, spread: { favorite: "ARI", line: 1.0 }, ou: { line: 44.5, prediction: "Over" }, pointDiff: 1.11, winner: "ARI", projectedScore: { CHI: 22.05, ARI: 23.16 } },
