...
export default function Picks() {
    ...
    const predictions = [
      { game: "DEN @ LAC", moneyline: { DEN: 120, LAC: -142 }, spread: { favorite: "LAC", line: 2.5 }, ou: { line: 41.0, prediction: "Under" }, pointDiff: 2.39, winner: "LAC", projectedScore: { DEN: 21.28, LAC: 23.66 } },
