...
export default function Picks() {
    ...
    const predictions = [
      ...
      { game: "LA @ NE", moneyline: { LA: -205, NE: 170 }, spread: { favorite: "LA", line: 4.5 }, ou: { line: 43.5, prediction: "Under" }, pointDiff: 0.77, winner: "NE", projectedScore: { LA: 21.69, NE: 22.47 } },
