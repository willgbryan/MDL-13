...
export default function Picks() {
    ...
    const predictions = [
        {
          game: "HOU @ KC",
          moneyline: { HOU: 350, KC: -455 },
          spread: { favorite: "KC", line: 8.5 },
          ou: { line: 41.5, prediction: "Over" },
          pointDiff: 4.90,
          winner: "KC",
          projectedScore: { HOU: 19.20, KC: 24.09 }
        },
        {
          game: "WAS @ DET",
          moneyline: { WAS: 350, DET: -455 },
          spread: { favorite: "DET", line: 8.5 },
          ou: { line: 55.5, prediction: "Under" },
          pointDiff: 7.12,
          winner: "DET",
          projectedScore: { WAS: 21.14, DET: 28.26 }
        },
        {
          game: "LA @ PHI",
          moneyline: { LA: 235, PHI: -290 },
          spread: { favorite: "PHI", line: 6.0 },
          ou: { line: 43.5, prediction: "Over" },
          pointDiff: 5.50,
          winner: "PHI",
          projectedScore: { LA: 20.32, PHI: 25.82 }
        },
        {
          game: "BAL @ BUF",
          moneyline: { BAL: -118, BUF: -102 },
          spread: { favorite: "BAL", line: 1.5 },
          ou: { line: 51.5, prediction: "Under" },
          pointDiff: 3.64,
          winner: "BUF",
          projectedScore: { BAL: 21.69, BUF: 25.33 }
        }
      ];
          ...
          <div className="w-full max-w-7xl px-4 py-8">
            <Card className="dark:bg-transparent">
              <CardHeader>
                ...
                <CardDescription>
                  MDL-13 predictions for Week 20 NFL games. These picks are based on historical data, use your own best judgement if bets are placed.
                </CardDescription>
              </CardHeader>
